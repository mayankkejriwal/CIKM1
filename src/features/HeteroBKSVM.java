...
public class HeteroBKSVM {
	
	
	public static ArrayList<Integer> column1;
	public static ArrayList<Integer> column2;
		
	
	
	//for generating heterogeneous BK weights
	
	public static int[] ExactMatch(String[] arr1, String[] arr2){
		int[] weight=new int[column1.size()];
		for(int i=0; i<column1.size(); i++){
			arr1[column1.get(i)]=arr1[column1.get(i)].trim();
			arr2[column2.get(i)]=arr2[column2.get(i)].trim();
				if(arr1[column1.get(i)].length()==0||arr2[column2.get(i)].length()==0){
					weight[i]=0;
					continue;
				}
								
				if(arr1[column1.get(i)].equals(arr2[column2.get(i)]))
					weight[i]=1;
				else
					weight[i]=0;
			}
	...
	public static int[] CommonAlphaNumeric(String[] arr1, String[] arr2){
		...
		for(int i=0; i<column1.size(); i++){
			...
			arr2[column2.get(i)]=arr2[column2.get(i)].trim();
				...
				String[] tokens1=arr1[column1.get(i)].split(Parameters.splitstring);
				String[] tokens2=arr2[column2.get(i)].split(Parameters.splitstring);
