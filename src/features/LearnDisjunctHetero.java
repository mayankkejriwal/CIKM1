...
public class LearnDisjunctHetero {

	//for learning heterogeneous disjunctive blocking scheme
	...
	public LearnDisjunctHetero(FeatureAnalysis a, int pos, int neg, int num_att1, int num_att2){
	...
	public LearnDisjunctHetero(FeatureAnalysis a, int pos, int neg, int num_att1,int num_att2, double recall){
		if(!Parameters.DNF||(Parameters.DNF&&tmp==null)){
			feats=a;
			totalFeats=feats.getA().get_num_features();
			if(Parameters.DNF)
